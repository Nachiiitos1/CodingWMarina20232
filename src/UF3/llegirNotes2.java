...
public class llegirNotes2 {
    ...
    public static final int NUMERO_FI = -1;
    public static void main (String[] args) {
        llegirNotes2 programa = new llegirNotes2();
        programa.inici();
    }
    public void inici() {
        try {
            File f = new File("C:\\Users\\Nacho\\IdeaProjects\\CodingWMarina2023\\src\\UF3\\NotesMarca.txt");
